...
namespace net {
    ...
    string_view uri::user_info() const noexcept {
    ...
    string_view uri::host() const noexcept {
    ...
    string_view uri::port() const noexcept {
    ...
    string_view uri::query() const noexcept {
    ...
    string_view uri::authority() const noexcept {
        if (!has_host()) {
            return string_view{};
        }
    ...
    string_view uri::view() const noexcept { return uri_view_; }
