...
using namespace net::algorithm;
using net::uri_comparison_level;
namespace net_detail = net::detail;

std::string net_detail::normalize_path_segments(string_view path) {
    std::string result;
...
std::string net_detail::normalize_path(string_view path,
