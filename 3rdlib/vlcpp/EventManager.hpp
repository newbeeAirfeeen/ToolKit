 ...
 */
    ...
    private:
        ...
        public:
            ...
            EventHandler(EventManager &em, libvlc_event_e eventType, FuncTpl &&userCallback, Wrapper wrapper)
                : m_userCallback(std::forward<Func>(userCallback)), m_eventManager(&em), m_wrapper(wrapper), m_eventType(eventType) {
     ...
     */
        ...
        EventManager(EventManager &&em)
            : Internal(std::move(em)), m_lambdas(std::move(em.m_lambdas)) {
        }
 ...
 */
    ...
    public:
        MediaEventManager(InternalPtr ptr, Media m)
            : EventManager(ptr), m_media(std::move(m)) {
        }
        ~MediaEventManager() {
 ...
 */
    ...
    public:
        MediaPlayerEventManager(InternalPtr ptr, MediaPlayer mp)
            : EventManager(ptr), m_mp(std::move(mp)) {
        }
 ...
 */
    ...
    public:
        MediaListEventManager(InternalPtr ptr, MediaList ml)
            : EventManager(ptr), m_ml(std::move(ml)) {
        }
 ...
 */
    ...
    public:
        MediaListPlayerEventManager(InternalPtr ptr, MediaListPlayer mlp)
            : EventManager(ptr), m_mlp(std::move(mlp)) {
        }
...
*/
    ...
    public:
        RendererDiscovererEventManager(InternalPtr ptr, RendererDiscoverer rd)
            : EventManager(ptr), m_rd(std::move(rd)) {
        }
