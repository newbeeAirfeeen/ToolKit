...
TEST(uri_normalization_test, string_comparison) {
  ...
  ASSERT_EQ(
      ...
      instance.normalize(net::uri_comparison_level::string_comparison).string());
}
...
TEST(uri_normalization_test, normalize_case_capitalized_scheme) {
  ...
  ASSERT_EQ("http://www.example.com/",
            instance.normalize(net::uri_comparison_level::syntax_based).string());
}
...
TEST(uri_normalization_test,
  ...
  net::uri instance("http://www.example.com/a/%2E/b/");
  ASSERT_EQ("http://www.example.com/a/b/",
            instance.normalize(net::uri_comparison_level::syntax_based).string());
}
...
TEST(uri_normalization_test,
  ...
  net::uri instance("http://www.example.com/a/%2E%2E/b/");
  ASSERT_EQ("http://www.example.com/b/",
            instance.normalize(net::uri_comparison_level::syntax_based).string());
}
...
TEST(uri_normalization_test,
  ...
  net::uri instance("http://www.example.com/a/../b/?key=value");
...
TEST(uri_normalization_test,
  ...
  net::uri instance("http://www.example.com/a/../b/#fragment");
...
TEST(uri_normalization_test,
  ...
  net::uri instance("http://www.example.com/a/../b/?key=value#fragment");
...
TEST(uri_normalization_test, path_depth_below_root) {
  net::uri instance("http://www.example.com/..");
  ASSERT_THROW(instance.normalize(net::uri_comparison_level::syntax_based),
               std::system_error);
}

TEST(uri_normalization_test, path_depth_below_root_2) {
  net::uri instance("http://www.example.com/a/../..");
  ASSERT_THROW(instance.normalize(net::uri_comparison_level::syntax_based),
               std::system_error);
}
...
TEST(uri_normalization_test, path_percent_encoded_unreserved) {
  net::uri instance("http://www.example.com/alpha123%2d%2e%5f%7e");
...
TEST(uri_normalization_test, query_percent_encoded_unreserved) {
  net::uri instance("http://www.example.com?foo=alpha123%2d%2e%5f%7e");
...
TEST(uri_test, path_adjacent_slashes_122) {
  ...
  net::uri instance("http://www.example.com/abc//elementary");
